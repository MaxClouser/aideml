...
def main():
    data_description = """The box variants .csv file contains the image name (without the extension), the bbox coordinates, and the class name (aircraft variant). The images/ dir has all of the images."""
